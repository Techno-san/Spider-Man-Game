(function (window, document) {
    ...
    document.getElementById("left").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_LEFT));
    document.getElementById("right").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_RIGHT));
    document.getElementById("jump").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_UP));
    document.getElementById("slide").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_DOWN));
    document.getElementById("attack").addEventListener("touchstart", () => simulateKeyPress(KEY.SPACEBAR));
    ...
    function setupMobileControls() {
        ...
        // Map touch buttons to game actions
        document.getElementById("left").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_LEFT));
        document.getElementById("left").addEventListener("touchend", () => simulateKeyRelease(KEY.ARROW_LEFT));

        document.getElementById("right").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_RIGHT));
        document.getElementById("right").addEventListener("touchend", () => simulateKeyRelease(KEY.ARROW_RIGHT));

        document.getElementById("jump").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_UP));
        document.getElementById("jump").addEventListener("touchend", () => simulateKeyRelease(KEY.ARROW_UP));

        document.getElementById("slide").addEventListener("touchstart", () => simulateKeyPress(KEY.ARROW_DOWN));
        document.getElementById("slide").addEventListener("touchend", () => simulateKeyRelease(KEY.ARROW_DOWN));

        document.getElementById("attack").addEventListener("touchstart", () => simulateKeyPress(KEY.SPACEBAR));
        document.getElementById("attack").addEventListener("touchend", () => simulateKeyRelease(KEY.SPACEBAR));
    }

    // Initialize Mobile Controls
    window.onload = setupMobileControls;
